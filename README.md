...
[Prompt Tower](https://marketplace.visualstudio.com/items?itemName=backnotprop.prompt-tower) is a VS Code extension that is also compatible with Cursor, Windsurf, and Google IDX. [Download it here](https://marketplace.visualstudio.com/items?itemName=backnotprop.prompt-tower).
